...
labelpath='F:\lly\data_allinfor\gid\label_gid5\';
labmicrDir=dir([labelpath '*.png']);
savepath='E:\2025.228\code_alldata\gid5\data_information\similar_infor\';
...
for kk=1:length(gray_value)
    ...
    if ismember(kk,irr_class)
        ...
        basicunit_infor_new(kk).allcurclass_area = basicunit_infor(kk).allcurclass_area(re_idx);
        basicunit_infor_new(kk).allcurclass_centroid = basicunit_infor_new(kk).allcurclass_centroid(re_idx);
        basicunit_infor_new(kk).allcurclass_BoundingBox = basicunit_infor(kk).allcurclass_BoundingBox(re_idx,:);
        basicunit_infor_new(kk).allcurclass_sparity = basicunit_infor(kk).allcurclass_sparity(re_idx);
        ...
        basicunit_infor_new(kk).allcurclass_countshistogram = basicunit_infor(kk).allcurclass_countshistogram(re_idx,:);
    end
end
